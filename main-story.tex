...
%   Filas 15-22  → Figura (SAFE)
%   Fila  15-22  → Body (SAFE)
%   Filas 23-24  → Footer (sangra OK)
%══════════════════════════════════════════════════════════════════════════════
\documentclass[9pt,oneside]{article}

%── 1. Paquetes ───────────────────────────────────────────────────────────────
\input{config/packages-story.tex}

%── 2. Geometría ───────────────────────────────────────────────────────────────
\input{config/geometry-story.tex}
...
\input{themes/story-accents.tex}
...
\input{config/typography-story.tex}
\input{config/tcolorbox-story.tex}

%── 7. Entornos ───────────────────────────────────────────────────────────────
\input{environments/generator.tex}
\input{environments/story-blocks.tex}

%── 8. Contenido de la historia ────────────────────────────────────────────────
\input{story-content.tex}
