...
% ─── Entornos personalizados (tcolorbox) registrados en cleveref ─────────────
...
\Crefname{ejemplo}{Ejemplo}{Ejemplos}
\crefname{ejerciciocomp}{ejercicio computacional}{ejercicios computacionales}
\Crefname{ejerciciocomp}{Ejercicio Computacional}{Ejercicios Computacionales}
\crefname{estrella}{estrella polar}{estrellas polares}
\Crefname{estrella}{Estrella Polar}{Estrellas Polares}
\crefalias{proposicioncounter}{proposicion}
\crefalias{teoremacounter}{teorema}
\crefalias{definicioncounter}{definicion}
\crefalias{ejemplocounter}{ejemplo}
\crefalias{ejerciciocompcounter}{ejerciciocomp}
\crefalias{estrellacounter}{estrella}
